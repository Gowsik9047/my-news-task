    ...
    <div className="featured-wrapper">
      ...
      <div className="top-grid">
        ...
        <div className="side-cards">
          <div className="medium-card card">
            <img src="/images/side1.jpg" alt="Side 1" />
            <div className="card-tags">
          ...
          <div className="medium-card card">
            <img src="/images/side2.jpg" alt="Side 2" />
            <div className="card-tags">
              <span className="tag red">நேரலை</span>
      ...
      <div className="small-grid">
        <div className="small-card card">
          <img src="/images/small1.jpg" alt="Small 1" />
          <div className="card-tags">
        ...
        <div className="small-card card">
          <img src="/images/small2.jpg" alt="Small 2" />
          <div className="card-tags">
        ...
        <div className="small-card card">
          <img src="/images/small3.jpg" alt="Small 3" />
          <div className="card-tags">
        ...
        <div className="small-card card">
          <img src="/images/small4.jpg" alt="Small 4" />
          <div className="card-tags">
